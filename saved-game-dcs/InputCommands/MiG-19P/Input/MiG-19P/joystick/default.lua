return {
	keyCommands = {
		...
		{cockpit_device_id = devices.FLIGHT_INST, pressed = finst_commands.BALT_Press_Selector, value_pressed = -0.25, name = _('Barometric Altimeter Setting Decrease'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.FLIGHT_INST, pressed = finst_commands.BALT_Press_Selector, value_pressed = 0.25, name = _('Barometric Altimeter Setting Increase'), category = {_('Instrument Panel'), _('Custom')}},
