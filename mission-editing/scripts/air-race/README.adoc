...
NOTE: This README describes MOOSE version of the script, now placed link:classic-moose[classic-moose] folder.
...
* Create a racing zone (trigger zone), name it distinctly, you will use the name later, e.g. `racezone-01`.
