...
local c = {
    ...
    debugMenuForAll = true, -- Race Debug F10 menu items, this makes them available for everyone
    debugMenuFor = {
    ...
    killZoneBehavior = 2,
    warningAboveAGL = 150, -- AGL in meters for warning sound (optional)
    killAboveAGL = 300, -- kill or disqualify, this follows killZoneBehavior setting (optional)
    ...
    enterRaceSound = "race-enter.ogg",
    finishRaceSound = "race-finish.ogg",
    unfinishedRaceSound = "race-unfinished.ogg",
    checkZoneSound = "race-check.ogg",
